...
{
	if((document.getElementById("txtmale").checked)||(document.getElementById("txtfemale").checked)||(document.getElementById("txtother").checked) )
		{
			return true;
		}
...
{
	if(validateFname() && validateEmail()   && validateOption()  && validatePassword() ) // all the functions are return ture
		{
			alert("submit all");
