...
<body>
	...
	$sql ="SELECT * FROM `lecture` WHERE `lec_id`= '".$_GET["id"]."'";
...
<table width="835" height="265" border="0" align="center">
  ...
  <tr>
    <td height="215" colspan="2"><form action="../../server side/l_serverside/updateLPic.php?id=<?php echo $_GET["id"];?>" method="post" enctype="multipart/form-data">
      
      <table width="383" border="0" align="center">
      <tr>
        <td colspan="2" bgcolor="#FFFFFF"><div align="center"><img src="../../img/2895125.png" width="198" height="195" /></div>
